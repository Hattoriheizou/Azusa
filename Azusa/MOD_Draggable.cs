...
namespace Azusa
{
    ...
    public partial class frmMain : Form
    {
        ...
        void Form_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            //
            this.drag = false;
            StatusMonitor.dragging = false;
            Configuration.frmPosX = this.Location.X +Configuration.frmWidth;
            Configuration.frmPosY = this.Location.Y + Configuration.frmHeight;
        }
